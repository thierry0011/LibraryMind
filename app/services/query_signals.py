...
_ENGLISH_FUNCTION_WORDS = {
    "a", "about", "after", "all", "an", "and", "any", "are", "before", "book",
    "books", "by", "can", "could", "do", "find", "for", "give", "have", "i",
    "in", "is", "it", "me", "more", "my", "of", "on", "or", "published",
    "show", "some", "than", "that", "the", "this", "to", "was", "were",
    "what", "who", "with", "would", "written", "you", "your",
}
